    ...
    public static function schema($command)
    {
        if (isset($command[2])) {
            if (file_exists('Schema/' . $command[2] . '.php')) {
                echo "\e[39mIni akan menghapus schema dan database \e[96m" . $command[2] . "\e[39m, ingin melanjutkan menghapus?, \e[93mYa [\e[39mKetik \e[96mYa\e[93m] / Tidak [\e[39mEnter\e[93m] \e[39m : ";
